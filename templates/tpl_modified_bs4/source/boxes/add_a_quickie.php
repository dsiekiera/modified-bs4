...
if (!$box_smarty->is_cached(CURRENT_TEMPLATE.'/boxes/box_add_a_quickie.html', $cache_id) || !$cache) {
  ...
  $box_smarty->assign('INPUT_FIELD',xtc_draw_input_field('quickie','','class="form-control"'));
  $box_smarty->assign('SUBMIT_BUTTON', '<button class="btn btn-secondary" type="submit"><i class="fa fa-cart-plus" aria-hidden="true"></i></button>');
